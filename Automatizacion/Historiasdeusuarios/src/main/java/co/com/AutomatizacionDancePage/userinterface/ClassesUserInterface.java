...
public class ClassesUserInterface {
    ...
    private static String xpathFecha1 =  "//*[@id=\"app\"]/div/div[1]/div[2]/div[2]/table/tbody/tr[1]/td[3]";
    private static String xpathFecha2 =  "//*[@id=\"app\"]/div/div[1]/div[2]/div[2]/table/tbody/tr[2]/td[5]";
    ...
    public static Target VALIDACION_PROFESOR = Target.the(" Texto profesor").located(By.xpath("//*[@id=\"infoModal\"]/div/div/div[2]/div/p[1]"));
