...
public class VisualizeClassValidation implements Question<Boolean> {
    public static VisualizeClassValidation hu4Validation() {return new VisualizeClassValidation();}
